...
class ETLTools:
    ...
    def extract_load(self, url: str, output_folder: str, format: str):
        ...
        try:
            ...
            # Ye tabhi kaam karega jab JSON mein 'results' key ho (jaise list endpoints mein hoti hai)
            ...
            return "Failed to extract data: 'results' key not found in the API response."
